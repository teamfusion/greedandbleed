...
public class MemoryModuleTypeRegistry {
    ...
    public static final DeferredRegister<MemoryModuleType<?>> MEMORY_MODULE_TYPES = DeferredRegister.create(ForgeRegistries.MEMORY_MODULE_TYPES, GreedAndBleed.MODID);
