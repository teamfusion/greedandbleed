...
public class PigmyModel<T extends MobEntity> extends BipedModel<T> {
	...
	public PigmyModel(float modelSize, int texWidthIn, int textHeightIn) {
		...
		this.body.texOffs(0, 16)
				.addBox(-4.0F, -16.0F + 16.0F + 7.0F, -3.0F, 8.0F, 10.0F, 6.0F, modelSize, false);

		this.head = new ModelRenderer(this);
		this.head.setPos(0.0F, 24.0F, 0.0F);
		this.head.texOffs(0, 0)
				.addBox(-5.0F, -24.0F + 16.0F + 7.0F, -4.0F, 10.0F, 8.0F, 8.0F, modelSize, false);

		ModelRenderer snout = new ModelRenderer(this);
		snout.setPos(0.0F, 0.0F, 0.0F);
		this.head.addChild(snout);
		snout.texOffs(42, 10)
				.addBox(-3.0F, -20.0F + 16.0F + 7.0F, -5.0F, 6.0F, 4.0F, 1.0F, modelSize, false);
		snout.texOffs(0, 0)
				.addBox(3.0F, -18.0F + 16.0F + 7.0F, -5.0F, 1.0F, 2.0F, 1.0F, modelSize, false);
		snout.texOffs(0, 3)
				.addBox(-4.0F, -18.0F + 16.0F + 7.0F, -5.0F, 1.0F, 2.0F, 1.0F, modelSize, false);

		this.earLeft = new ModelRenderer(this);
		this.earLeft.setPos(-6.0F, -17.0F, -3.0F);
		this.head.addChild(this.earLeft);
		this.setRotationAngle(this.earLeft, 0.0F, 0.0F, 0.1745F);
		this.earLeft.texOffs(39, 26)
				.addBox(-1.0F + 10.0F, -6.0F + 16.0F + 7.0F, 0.0F, 1.0F, 6.0F, 6.0F, modelSize, false);

		this.earRight = new ModelRenderer(this);
		this.earRight.setPos(7.0F, -17.0F, -3.0F);
		this.head.addChild(this.earRight);
		this.setRotationAngle(this.earRight, 0.0F, 0.0F, -0.1745F);
		this.earRight.texOffs(14, 38)
				.addBox(-1.0F - 10.0F, -6.0F + 16.0F + 7.0F, 0.0F, 1.0F, 6.0F, 6.0F, modelSize, false);

		this.hair = new ModelRenderer(this);
		this.hair.setPos(0.0F, 0.0F, 0.0F);
		this.head.addChild(this.hair);
		this.hair.texOffs(0, 22)
				.addBox(0.0F, -30.0F + 16.0F + 7.0F, -4.0F, 0.0F, 12.0F, 10.0F, modelSize, false);

		this.leftArm = new ModelRenderer(this);
		this.leftArm.setPos(0.0F, 24.0F, 0.0F);
		this.leftArm.texOffs(31, 11).
				addBox(4.0F - 5.0F, -16.0F + 14.0F + 7.0F, -2.0F, 3.0F, 10.0F, 5.0F, modelSize, false);

		this.rightArm = new ModelRenderer(this);
		this.rightArm.setPos(0.0F, 24.0F, 0.0F);
		this.rightArm.texOffs(23, 27)
				.addBox(-7.0F + 5.0F, -16.0F + 14.0F + 7.0F, -2.0F, 3.0F, 10.0F, 5.0F, modelSize, false);

		this.leftLeg = new ModelRenderer(this);
		this.leftLeg.setPos(0.0F, 24.0F, 0.0F);
		this.leftLeg.texOffs(35, 38)
				.addBox(0.0F, -6.0F + 4.0F + 7.0F, -2.0F, 4.0F, 6.0F, 4.0F, modelSize, false);

		this.rightLeg = new ModelRenderer(this);
		this.rightLeg.setPos(0.0F, 24.0F, 0.0F);
		this.rightLeg.texOffs(36, 0)
				.addBox(-4.0F, -6.0F + 4.0F + 7.0F, -2.0F, 4.0F, 6.0F, 4.0F, modelSize, false);
