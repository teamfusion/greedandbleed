...
public class ModBiomes {
    ...
    public static Biome hogedewHollow(HolderGetter<PlacedFeature> holderGetter, HolderGetter<ConfiguredWorldCarver<?>> holderGetter2) {
        MobSpawnSettings mobSpawnSettings = (new MobSpawnSettings.Builder()).addMobCharge(EntityTypeRegistry.HOGLET.get(), 0.7, 0.15F).addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityTypeRegistry.HOGLET.get(), 9, 3, 4)).addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityType.STRIDER, 60, 1, 2)).build();
        ...
        builder.addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, NetherPlacements.SPRING_OPEN).addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, NetherPlacements.PATCH_FIRE).addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, NetherPlacements.GLOWSTONE_EXTRA).addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, NetherPlacements.GLOWSTONE).addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, OrePlacements.ORE_MAGMA).addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, NetherPlacements.SPRING_CLOSED).addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, ModPlacedFeatures.HOGDEW_PATCH).addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, ModPlacedFeatures.HOGDEW_BUBBLE).addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.HOGDEW_FUNGUS).addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.HOGDEW_LUMPS).addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.HOGDEW_HOLLOW_VEGITATION);
