...
public class ModBiomes {
    ...
    public static Biome hogedewHollow(HolderGetter<PlacedFeature> holderGetter, HolderGetter<ConfiguredWorldCarver<?>> holderGetter2) {
        ...
        builder.addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, NetherPlacements.SPRING_OPEN).addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, NetherPlacements.PATCH_FIRE).addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, NetherPlacements.GLOWSTONE_EXTRA).addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, NetherPlacements.GLOWSTONE).addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, OrePlacements.ORE_MAGMA).addFeature(GenerationStep.Decoration.UNDERGROUND_DECORATION, NetherPlacements.SPRING_CLOSED).addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.HOGDEW_BUBBLE).addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.HOGDEW_LUMPS).addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.HOGDEW_FUNGUS).addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.HOGDEW_PATCH);
