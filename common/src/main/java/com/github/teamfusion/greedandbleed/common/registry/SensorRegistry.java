...
import com.github.teamfusion.greedandbleed.common.entity.brain.sensor.PigmySpecificSensor;
...
public class SensorRegistry {
    ...
    public static final Supplier<SensorType<PigmySpecificSensor>> PYGMY_SPECIFIC_SENSOR = register("pygmy_specific_sensor", PigmySpecificSensor::new);
