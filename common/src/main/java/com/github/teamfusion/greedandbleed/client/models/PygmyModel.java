...
public class PygmyModel<T extends GBPiglin> extends HierarchicalModel<T> implements ArmedModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition right_arm = body.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(0, 55).addBox(-1.0F, -2.0F, -2.0F, 3.0F, 10.0F, 5.0F, new CubeDeformation(0.25F))
                .texOffs(32, 40).addBox(-1.0F, -2.0F, -2.0F, 3.0F, 10.0F, 5.0F, new CubeDeformation(0.5F)), PartPose.offset(5.0F, 2.0F, 0.0F));

        PartDefinition left_arm = body.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(16, 40).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 10.0F, 5.0F, new CubeDeformation(0.25F))
