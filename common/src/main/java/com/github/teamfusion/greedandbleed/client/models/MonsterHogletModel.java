...
public class MonsterHogletModel<T extends LivingEntity> extends AbstractHogletModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition LeftArm = Body.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(10, 34).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, 3.0F, -2.7143F));

        PartDefinition RightArm = Body.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(18, 34).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, 2.0F, -2.7143F));
        ...
        PartDefinition LeftEar = head.addOrReplaceChild("LeftEar", CubeListBuilder.create().texOffs(34, 24).addBox(-0.5F, -2.0F, -1.5F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.5F, -4.3571F, -0.8286F));

        PartDefinition RightEar = head.addOrReplaceChild("RightEar", CubeListBuilder.create().texOffs(26, 34).addBox(3.0F, -14.0F, -7.0F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 7.6429F, 4.6714F));
        ...
        PartDefinition LeftLeg = Pelvis.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -1.0F, -1.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, 0.0F, 0.5F));

        PartDefinition RightLeg = Pelvis.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(28, 0).mirror().addBox(-1.5F, -1.0F, -1.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(2.0F, 0.0F, 0.5F));
