...
/*
 * Credit: bagu_chan (https://github.com/baguchan/Bagus-Mob/blob/master/src/main/java/baguchan/bagusmob/entity/brain/behaviors/SetWalkTargetFromAttackTargetIfTargetFar.java)
 */
public class SetWalkTargetFromAttackTargetIfTargetFarWithNotRiding {
