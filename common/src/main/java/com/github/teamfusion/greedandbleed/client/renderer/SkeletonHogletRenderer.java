...
import com.github.teamfusion.greedandbleed.common.entity.piglin.SkeletonHoglet;
import net.minecraft.client.renderer.entity.EntityRendererProvider;
import net.minecraft.client.renderer.entity.MobRenderer;
import net.minecraft.resources.ResourceLocation;

public class SkeletonHogletRenderer<T extends SkeletonHoglet> extends MobRenderer<T, AbstractHogletModel<T>> {
    public SkeletonHogletRenderer(EntityRendererProvider.Context context) {
    ...
    public ResourceLocation getTextureLocation(T entity) {
        return new ResourceLocation(GreedAndBleed.MOD_ID, "textures/entity/hoglet/skeleton_hoglet.png");
    }
}