...
public class PygmyTaskManager<T extends Pigmy> extends TaskManager<T> {
    ...
    private static Optional<? extends LivingEntity> getTamedTargetIfWithinRange(GBPigmy abstractPiglin, MemoryModuleType<? extends LivingEntity> memoryModuleType) {
