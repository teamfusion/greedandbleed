...
import com.github.teamfusion.greedandbleed.common.entity.piglin.ZombifiedHoglet;
import net.minecraft.client.renderer.entity.EntityRendererProvider;
import net.minecraft.client.renderer.entity.MobRenderer;
import net.minecraft.resources.ResourceLocation;

public class ZombifiedHogletRenderer<T extends ZombifiedHoglet> extends MobRenderer<T, AbstractHogletModel<T>> {
    public ZombifiedHogletRenderer(EntityRendererProvider.Context context) {
    ...
    public ResourceLocation getTextureLocation(T entity) {
        return new ResourceLocation(GreedAndBleed.MOD_ID, "textures/entity/hoglet/zombified_hoglet.png");
    }
}