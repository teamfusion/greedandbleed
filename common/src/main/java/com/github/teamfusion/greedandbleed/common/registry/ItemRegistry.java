...
public class ItemRegistry {
    ...
    public static final Supplier<Item> SHRYGMY_SPAWN_EGG = create("shrygmy_spawn_egg", () -> MobRegistry.spawnEgg(EntityTypeRegistry.SHRYGMY, 0xAD5532, 0xFFA468, new Item.Properties()));
    public static final Supplier<Item> HOGGART_SPAWN_EGG = create("hoggart_spawn_egg", () -> MobRegistry.spawnEgg(EntityTypeRegistry.HOGGART, 0xAD5532, 0xF2BA86, new Item.Properties()));
