...
public class BlockRegistry {
    ...
    public static final Supplier<Block> HOGDEW_PLANKS_FENCE = createWithItem("hogdew_fence", () -> new FenceBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PINK).forceSolidOn().instrument(NoteBlockInstrument.BASS).strength(2.0f, 3.0f).sound(SoundType.NETHER_WOOD)));
    public static final Supplier<Block> HOGDEW_PLANKS_FENCE_GATE = createWithItem("hogdew_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PINK).forceSolidOn().instrument(NoteBlockInstrument.BASS).strength(2.0f, 3.0f).sound(SoundType.NETHER_WOOD), WoodTypeRegistry.HOGDEW));
